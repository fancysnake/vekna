...
def _answered(
    ...
    *,
    ...
    return asyncio.run(
        double.answer(call, on_delta=on_delta, gate=gate, ask=ask or refuse)
    )
...
class TestCodingDouble:
    ...
    def test_the_scripted_text_comes_back():
        ...
        reply = _answered(double, _call("make it green"))
    ...
    def test_a_model_reply_is_serialised_for_the_medium_to_validate():
        ...
        assert _answered(double, _call("review")).text == '{"verdict":"ship"}'
    ...
    def test_calls_are_recorded_whole_and_prompts_read_off_them():
        ...
        _answered(double, _call("first"))
        _answered(double, _call("second", resume="s1"))
    ...
    def test_a_fresh_call_is_handed_a_new_session_id():
        ...
        first = _answered(double, _call("first"))
        second = _answered(double, _call("second"))
    ...
    def test_a_resuming_call_stays_on_its_session():
        ...
        assert _answered(double, _call("again", resume="s1")).session_id == "s1"
    ...
    def test_the_reply_streams_the_way_an_agent_s_output_does():
        ...
        _answered(double, _call("work"), on_delta=deltas.append)
    ...
    def test_a_scripted_tool_meets_the_gate_the_call_declared():
        ...
        _answered(double, _call("work"), gate=gate)
    ...
    def test_a_scripted_question_reaches_the_human_and_the_answer_is_kept():
        ...
        _answered(double, _call("work"), ask=ask)
...
class TestShellDouble:
    ...
    def test_the_scripted_reply_comes_back_and_the_command_is_recorded():
        ...
        reply = double.answer(ShellCall(command="mise run lint:py"), None)
    ...
    def test_output_reaches_on_line_the_way_bash_output_does():
        ...
        double.answer(ShellCall(command="anything"), lines.append)
