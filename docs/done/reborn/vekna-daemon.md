...
See [`../../reborn/common.md`](../../reborn/common.md) — process model, wire
protocol, replay rule, CLI surface.
...
lands on top of this at [locks](../../reborn/locks.md).
...
state rebuilt from replay ([locks](../../reborn/locks.md)). **Takeover** —
