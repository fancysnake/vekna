...
vekna rituals check                           # unreachable steps, hidden transitions, name collisions — 0.6.0
vekna cast <ritual> --unattended              # a decide fails at the boundary instead of waiting on nobody — 0.6.0
